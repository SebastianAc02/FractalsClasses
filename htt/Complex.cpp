...
// Friend function to overload the * operator./ Using distribute property ( the imag sqrt is just the imag number )
...
//Getting magnitude, separated every part of the algo in different doubles 
